    ...
    try {
      const response = await fetch('https://formspree.io/f/xkgbrkke', {
        ...
        body: JSON.stringify({
          ...
          _replyto: formData.email, // Ensure replies go to sender
        }),
      });
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:05harisshabbir@gmail.com"
          ...
          <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700 hover:border-blue-400 transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-medium rounded-lg hover:from-blue-700 hover:to-cyan-600 transition-all duration-300 hover:shadow-lg ${
