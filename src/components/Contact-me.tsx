    ...
    <section id="contact" className="relative py-24 px-6 bg-gradient-to-br from-[#0f0f0f] via-[#141414] to-[#0c0c0c] text-white overflow-hidden font-sans">
      ...
      >
        ...
        >
          ...
          {/* Contact Info */}
          <motion.div 
            className="backdrop-blur-md bg-white/5 p-10 rounded-3xl border border-white/20 shadow-lg hover:shadow-cyan-500/40 transition-all duration-300"
            variants={itemVariants}
          >
          ...
          {/* Contact Form */}
          <motion.div 
            className="backdrop-blur-md bg-white/5 p-10 rounded-3xl border border-white/20 shadow-lg hover:shadow-purple-500/40 transition-all duration-300"
            variants={itemVariants}
          >
